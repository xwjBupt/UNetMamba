...
gpus = "auto"  # "auto"  # default or gpu ids:[0] or gpu nums: 2, more setting can refer to pytorch_lightning
...
model.cuda().eval()
input = torch.randn(
    (1, 3, image_size, image_size), device=next(model.parameters()).device
)
